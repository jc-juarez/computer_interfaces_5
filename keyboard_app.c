...
{
    if(appData.isSwitchPressed) appData.currState = !appData.currState;

    if(!appData.currState){
        ...
        {/* Indicate no event *//* Indicate no event *//* Indicate no event *//* Indicate no event *//* Indicate no event */
            /* Indicate no event */
...
// Example Line// Example Line// Example Line// Example Line 
